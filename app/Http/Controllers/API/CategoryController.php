...
class CategoryController extends Controller
{
    ...
    public static function getCategoriesViaServiceProvider(Request $request)
    {
        try {
            ...
            return response([
                ...
                'message' => __('Categories '), 'data' => ['categories' => $categories->items(), 'after' => $after, 'before' => $before, 'per_page' => $per_page]
            ], 200);
        } catch (Exception $ex) {
    ...
    public  function getPackages(Request $request)
    {
        try {
            ...
            if ($request->list_by == 'purchased') {
                ...
                if (config('client_connected') && (Config::get("client_data")->domain_name == "curenik")) {
                    if ($user && $user->hasRole('service_provider')) {
                        $packages = Package::select('id', 'title', 'description', 'price', 'image', 'total_requests', 'category_id', 'package_type', 'created_by', 'filter_id', 'created_from_user', 'valid_from', 'valid_to', 'service_id', 'service_name')->where('category_id', $request->category_id)->where('filter_id', $filter_id)
                            ->where([
                ...
                if (config('client_connected') && (Config::get("client_data")->domain_name == "curenik")) {
                    $current_date = Carbon::parse($timezone)->setTimezone('UTC')->format('Y-m-d');

                    if ($user && $user->hasRole('service_provider')) {
                        $packages = Package::select('id', 'title', 'description', 'price', 'image', 'total_requests', 'category_id', 'package_type', 'created_by', 'created_from_user', 'filter_id', 'valid_from', 'valid_to', 'service_id', 'service_name')->where('category_id', $request->category_id)->where('filter_id', $filter_id)
                            ->where('package_type', $request->type)
                        ...
                        if ($request->doctor_id) {
                            $packages = Package::select('id', 'title', 'description', 'price', 'image', 'total_requests', 'category_id', 'package_type', 'created_by', 'created_from_user', 'filter_id', 'package_created_for', 'valid_from', 'valid_to', 'service_id', 'service_name')->where('category_id', $request->category_id)->where('filter_id', $filter_id)
                                ->where('package_type', $request->type)
                        ...
                        if (isset($request->package_type) && ($request->package_type) == 'customer') {

                            $packages = Package::select('id', 'title', 'description', 'price', 'image', 'total_requests', 'category_id', 'package_type', 'created_by', 'filter_id', 'valid_from', 'valid_to', 'service_id', 'service_name')->where('category_id', $request->category_id)->where('filter_id', $filter_id)
                                ->where('package_type', $request->type)
            ...
            return response([
                'status' => "success", 'statuscode' => 200,
                'message' => __('packages listing'), 'data' => ['packages' => $packages->items(), 'after' => $after, 'before' => $before, 'per_page' => $per_page]
            ], 200);
        } catch (Exception $ex) {
            return response(['status' => "error", 'statuscode' => 500, 'message' => $ex->getMessage()], 500);
        }
    ...
    public  function getPackageDetail(Request $request)
    {
        try {
            ...
            if (config('client_connected') && (Config::get("client_data")->domain_name == "curenik")) {
                $package = Package::select('id', 'title', 'description', 'price', 'image', 'total_requests', 'category_id', 'created_by', 'valid_to', 'valid_from', 'service_id', 'service_name')->where('id', $request->package_id)->first();
            } else {
            ...
            return response([
                'status' => "success", 'statuscode' => 200,
                'message' => __('packages detail'), 'data' => ['detail' => $package]
            ], 200);
        } catch (Exception $ex) {
            return response(['status' => "error", 'statuscode' => 500, 'message' => $ex->getMessage()], 500);
        }
    ...
    public  function getAdditionalFields(Request $request)
    {
        try {
            ...
            return response([
                'status' => "success", 'statuscode' => 200,
                'message' => __('additionaldetail listing'), 'data' => ['additional_details' => $additionaldetail->items(), 'after' => $after, 'before' => $before, 'per_page' => $per_page]
            ], 200);
        } catch (Exception $ex) {
            return response(['status' => "error", 'statuscode' => 500, 'message' => $ex->getMessage()], 500);
        }
    ...
    public  function getAdditionalDocuments(Request $request)
    {
        ...
        try {
            ...
            return response([
                'status' => "success", 'statuscode' => 200,
                'message' => __('additionaldocument listing'), 'data' => ['additional_details' => $additionaldetail->items(), 'after' => $after, 'before' => $before, 'per_page' => $per_page]
            ], 200);
        } catch (Exception $ex) {
            return response(['status' => "error", 'statuscode' => 500, 'message' => $ex->getMessage()], 500);
        }
    ...
    public  function postAdditionalFields(Request $request)
    {
        try {
            ...
            return response([
                'status' => "success", 'statuscode' => 200,
                'message' => __('additionaldetail added/updated'), 'data' => ['additionals' => $input['fields']]
            ], 200);
        } catch (Exception $ex) {
            return response(['status' => "error", 'statuscode' => 500, 'message' => $ex->getMessage()], 500);
        }
    ...
    public static function putClassStatusChange(Request $request)
    {
        try {
            ...
            $rules = [
                'class_id' => 'required|exists:ct_classes,id',
    ...
    public static function getClasses(Request $request)
    {
        try {
            ...
            return response([
                'status' => "success", 'statuscode' => 200,
                'message' => __('Class Listing'), 'data' => ['classes' => $classes->items(), 'after' => $after, 'before' => $before, 'per_page' => $per_page]
            ], 200);
        } catch (Exception $ex) {
            return response(['status' => "error", 'statuscode' => 500, 'message' => $ex->getMessage()], 500);
        }
    ...
    public static function getClassDetail(Request $request)
    {
        try {
            ...
            return response([
                'status' => "success", 'statuscode' => 200,
                'message' => __('Class Detail'), 'data' => $class
            ], 200);
        } catch (Exception $ex) {
            return response(['status' => "error", 'statuscode' => 500, 'message' => $ex->getMessage()], 500);
        }
