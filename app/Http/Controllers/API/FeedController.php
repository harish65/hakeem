...
class FeedController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $rules = [
                'type' => 'required|in:blog,faq,article,promotional,tip,question,forum',
        ];
    ...
    public function store(Request $request)
    {
        try{
            ...
            $rules = [
                ...
                'type'=>'required|in:blog,article,promotional,forum',
            ];
            $validator = Validator::make($request->all(),$rules);
            if ($validator->fails()) {
                return response(array('status' => "error", 'statuscode' => 400, 'message' =>
            ...
            $create->category_id = isset($request->category_id) ? $request->category_id : null;
            $create->save();
            if($create){
    ...
    public function postUpdateFeed(Request $request,$feed_id)
    {
        try {
            ...
            $feed->category_id = isset($request->category_id) ?$request->category_id:$feed->category_id;
            $feed->save();
            if($feed){
