...
class ConsultantController extends Controller{
    ...
    public function show(User $user){
        ...
        $user->article = Feed::where(['type' =>'article','user_id' => $user->id])->get();
        $user->blog = Feed::where(['type' =>'blog','user_id' => $user->id])->get();
        $user->promotional = Feed::where(['type' =>'promotional','user_id' => $user->id])->get();
    ...
    public function update(Request $request, User $user)
    {
        ...
        }else if(isset($request->account_wallet_ajax)){
            $user->wallet->balance = $request->balance;
            $user->wallet->save();
            return response()->json(['status'=>'success','account_wallet_ajax'=>true]);
