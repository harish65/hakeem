...
$(document).ready(function ($) {
    ...
    $("#home_doctor_sign_up_modal_btn").click(function (e) {
        e.preventDefault();
        let role_type = AUTH_USER_TYPE_DOCTOR;
        $('#loginModal').modal('show');
        $('#loginModal #phone').val('');
        $("#loginform .phone").html("");
        $('#loginform #phone').css('border','');
    ...
    $('#sign_upnextbtn').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#otp-email").modal('show');
                $('#otp-email .phonenumber').html('');
                $('#otp-email .phonenumber').html(response.email);
                sendemailotp(response.email);
                // $('#otp-popup .role_type').val(response.role_type);
                // var user = response.userid;
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response.rolename == 'service_provider')
                {
                    ...
                    if(response.account_verified == "true" && (response.signuptype == null || response.signuptype==''))
                    {
                    ...
                    if(response.account_verified == "false" &&  (response.signuptype == null || response.signuptype==''))
                    {
                ...
                {
                    window.location.href = base_url + '/web/courses' ;
                }
                if(response.rolename == 'customer' && response.applyoption == 'register')
                {
                    window.location.href = base_url + '/edit/profile';
                ...
                if(response.rolename=='' ||response.rolename==null){
                    window.location.href = base_url;
                }
    ...
    $('#otp-email .resend_otp_email').on('click',function(e){
        e.preventDefault();
        $.ajax({
            type: "post",
            dataType: "json",
            url: base_url + '/users/resendotpemail',
            data: $('#otpemail').serialize(),
            success: function (response) {
                //var data = response;
                //  console.log(response);
                  $('#otp-email').modal('show');
                  $('#otp-email .phonenumber').html(response.data);
                  $('#otp-email #otp').val(response.otp);
                  $('#otp-email #email').val(response.data);
                  $("#otp-email .msgdivsuccess").text(response.message);
                  $("#otp-email .msgdivsuccess").show();
                  $('#otp-email .msgdivsuccess').fadeIn('slow').delay(2000).fadeOut('slow');
            ...
            error: function (jqXHR) {
                ...
                if (jqXHR.responseJSON.status === "error") {
                    ...
                    // console.log(jqXHR.responseJSON.message);
                    // alert(jqXHR.responseJSON.message);
                    $("#otp-email .msgdiv").text(jqXHR.responseJSON.message);
                    $("#otp-email .msgdiv").show();
                    $('#otp-email .msgdiv').fadeIn('slow').delay(2000).fadeOut('slow');
                }
            }
        });
...
function readURLImg(input) {
  ...
  $('.availbilityform .newrow').click(function(e){
      e.preventDefault();

   $(".availbilityform #customFields").append('<div class="new_row row align-items-center"><div class="col-md-11 col-10"><div class="row common-form"><div class="col-sm-6"><div class="form-group"><label>From</label>  <div class="time_icon position-relative "><input class="form-control timepicker" type="text" placeholder="11:00" name="start_time[]" required > <i class="fa fa-clock-o icon-pos icon-time" aria-hidden="true"></i></div></div></div><div class="col-sm-6"><div class="form-group"><label>To</label>  <div class="time_icon position-relative "><input class="form-control timepicker" type="text" placeholder="11:00" name="end_time[]" required><i class="fa fa-clock-o icon-pos icon-time" aria-hidden="true"></i></div></div></div></div></div><div class="col-md-1 col-2"><label></label> <a class="remCF del-ic" href="#"><i class="fa fa-trash-o"></i></a></div></div>');
  ...
  $('#editAvailbityModal .newrow').click(function(){
    $("#editAvailbityModal #customFields").append('<div class="new_row row align-items-center"><div class="col-md-11 col-10"><div class="row common-form"><div class="col-sm-6"><div class="form-group"><label>From</label>  <div class="time_icon position-relative "><input class="form-control timepicker" type="text" placeholder="11:00" name="start_time[]" required > <i class="fa fa-clock-o icon-pos icon-time" aria-hidden="true"></i></div></div></div><div class="col-sm-6"><div class="form-group"><label>To</label>  <div class="time_icon position-relative "><input class="form-control timepicker" type="text" placeholder="11:00" name="end_time[]" required><i class="fa fa-clock-o icon-pos icon-time" aria-hidden="true"></i></div></div></div></div></div><div class="col-md-1 col-2"><label></label> <a class="remCF del-ic" href="#"><i class="fa fa-trash-o"></i></a></div></div>');

   });


  $(".availbilityform #customFields").on('click','.remCF',function(e){
      e.preventDefault();
       //alert("asda");
...
$("#otp-email #Submit").click(function () {
    // e.preventDefault();
    $.ajax({
        type: "post",
        dataType: "json",
...
$(".timepicker").timepicker({
  ...
  $("#menu-btn").click(function(){
    $('#menu-btn-slide').toggleClass('selected');
   });

//   $('##menu-btn-slide').click(function(){
//     $('#menu-btn-slide').removeClass('selected')
