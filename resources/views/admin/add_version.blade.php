          ...
          <div class="page-title-box">
              <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                      ...
                      <li class="breadcrumb-item"><a href="{{ route('app_version') }}">App Versions</a></li>
                      <li class="breadcrumb-item active">Add App Version</li>
                  </ol>
              </div>
              <h4 class="page-title">Add App Version</h4>
          </div>
      </div>
  </div> 
      ...
      <form role="form" action="{{ url('admin/app_version/create')}}" method="post">
        ...
        <input type="hidden" name="_method" value="POST">
          ...
          <div class="card-footer">
            ...
            <a class="btn btn-info" href="{{ route('app_version')}}">Cancel</a>
          </div>
      </form>
  </div>
</div>
