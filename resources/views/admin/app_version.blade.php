        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card-box bg-pattern">
                    <div class="text-center">
                        ...
                        <h4 class="mb-1 font-20">Android, {{ $name1 }} App</h4>
            ...
            <div class="col-lg-4">
                <div class="card-box bg-pattern">
                    <div class="text-center">
                        <img src="{{asset('assets/images/android.png')}}"alt="logo" class="avatar-xl rounded-circle mb-3">
                        <h4 class="mb-1 font-20">Android, {{ $name2 }} App</h4>
            ...
            <div class="col-lg-4">
                <div class="card-box bg-pattern">
                    <div class="text-center">
                        ...
                        <h4 class="mb-1 font-20">IOS {{ $name1 }} APP</h4>
            ...
            <div class="col-lg-4">
                <div class="card-box bg-pattern">
                    <div class="text-center">
                        <img src="{{asset('assets/images/companies/apple.png')}}"alt="logo" class="avatar-xl rounded-circle mb-3">
                        <h4 class="mb-1 font-20">IOS {{ $name2 }} APP</h4>
