@extends('layouts.vertical', ['title' => 'Add '.__('text.Clinic')])
...
<div class="container-fluid">
  <div class="row">
        <div class="col-12">
            <div class="page-title-box mt-2">
                ...
                <h3 class="card-title">Add {{ __('text.Clinic') }}</h3>
            </div>
        </div>
    </div> 
  <div class="card card-primary row ">
      <!-- /.card-header -->
      <!-- form start -->
      <form role="form"  autocomplete="off" action="{{ url('admin/clinic/add_request')}}" method="post" enctype="multipart/form-data"  >
        <div class="col-lg-12">
        ...
        <input type="hidden" name="_method" value="POST">
          <div class="card-body">
            <div class="row">
              ...
              <div class="form-group col-md-6 ">
                ...
                <input type="number" name="commission" min="1" max="100" class="form-control" value="{{ old('commission') }}" id="commission" placeholder="Commission Percentage %">
                @if ($errors->has('name'))
                        <span class="text-danger">{{ $errors->first('name') }}</span>
                @endif
              </div>
          ...
          <div class="row">  
            <div class="form-group col-md-6">
              ...
              <input type="email" class="form-control" autocomplete="off" name="email" value="{{ old('email') }}" id="exampleInputEmail1" placeholder="Enter email" autocomplete="off">
              @if ($errors->has('email'))
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" readonly value="Clinic">
              <input type="hidden" readonly value="47" name="category">
            </div>
