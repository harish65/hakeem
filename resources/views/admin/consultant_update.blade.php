            ...
            <div class="page-title-box mt-2">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin_dashboard') }}">List Dcotors</a></li>
                        @else
                        <li class="breadcrumb-item active"><a href="{{ route('consultants.index') }}">List {{ __('text.Vendors') }}</a></li>
                        @endif
                        <li class="breadcrumb-item active">Edit</li>
                    </ol>
                </div>
                <h3 class="card-title">Edit {{ __('text.Vendor') }}</h3>
            </div>
        </div>
    </div> 
            ...
            @if(config('client_connected') && (Config::get("client_data")->domain_name=="hakeemcare" || Config::get("client_data")->domain_name=="hakeemcare"))
              <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="long" class="form-control" value="{{ $consultant->long }}"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="lat" class="form-control" value="{{ $consultant->lat }}"
