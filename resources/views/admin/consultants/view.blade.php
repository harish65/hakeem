              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                        ...
                        <img src="{{ Storage::disk('spaces')->url('thumbs/'.$consultant->profile_image) }}" alt="User Image" class="profile-user-img img-fluid img-circle">
                        @else
                        <img src="{{ url('/').'/default/user.jpg' }}" alt="User Image" class="rounded-circle avatar-lg">
                        @endif
                    </div>
                        ...
                        @foreach($additional->documents as $document)
                          ...
                          <div class="post clearfix">
                            <div class="user-block">
                              ...
                              @endif
                              @php $file_ext = pathinfo($document->file_name, PATHINFO_EXTENSION); @endphp
                              @if(strtolower($document->type)=='pdf' || $file_ext=='pdf')
          ...
          <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h5 class="card-title">Articles Listing</h5>
                    </div>
                    <!-- /.card-header -->
                      <div class="card-body">
                        <table id="scroll-horizontal-datatable" class="table w-100 nowrap">
                          ...
                          <tbody>
                            @foreach($consultant->article as $index => $articles)
                            <tr>
                              <td>{{ $index+1 }}</td>
                              <td>{{ $articles->title }}</td>
                              <td>{{ $articles->description }}</td>
                              <td><image src="{{ Storage::disk('spaces')->url('thumbs/'.$articles->image) }}"></td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                    ...
                    <!-- /.card-header -->
                      <div class="card-body">
                        <table id="scroll-horizontal-datatable2" class="table w-100 nowrap">
                          ...
                          <tbody>
                            @foreach($consultant->blog as $bg => $blogs)
                            <tr>
                              <td>{{ $bg+1 }}</td>
                              <td>{{ $blogs->title }}</td>
                              <td>{{ $blogs->description }}</td>
                              <td><image src="{{ Storage::disk('spaces')->url('thumbs/'.$blogs->image) }}"></td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
                    ...
                    <!-- /.card-header -->
                      <div class="card-body">
                        <table id="scroll-horizontal-datatable3" class="table w-100 nowrap">
                          ...
                          <tbody>
                            @foreach($consultant->promotional as $pr => $promotionals)
                            <tr>
                              <td>{{ $pr+1 }}</td>
                              <td>{{ $promotionals->title }}</td>
                              <td>{{ $promotionals->description }}</td>
                              <td><image src="{{ Storage::disk('spaces')->url('thumbs/'.$promotionals->image) }}"></td>
                            </tr>
                            @endforeach
                          </tbody>
                        </table>
...
<script>
 ...
 $("#activeExpert").on('click',function(e){
        ...
        Swal.fire({
          title: 'Are you sure?',
          text: "Do you want to "+text+" this account?",
          showCancelButton: true,
          confirmButtonColor: '#3085d6',
          cancelButtonColor: '#d33',
