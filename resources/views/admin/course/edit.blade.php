    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('course.update',$filterType->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="_method" value="put">
                        <div class="form-group row">
                            <div class="col-md-6">
                                <label>Title</label><br>
                                <textarea class="form-control" placeholder="Title" name="title" row="5" required>{{ old('title')?old('title'):$filterType->title }}</textarea>
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <input id="example-color" type="color" name="color_code" value="{{ old('color_code')?old('color_code'):$filterType->color_code }}" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div>
                                    <input type="file" value="" name="image_icon" id="exampleInputFile" accept="image/*">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
