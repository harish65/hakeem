...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-xl-3">
            <div class="widget-rounded-circle card-box">
            <a href="#" data-toggle="modal" data-target="#radius_modal">
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-lg rounded-circle bg-soft-info border-info border">
                                <i class="fas fa-map-marker font-22 avatar-title text-info"></i>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="text-right">
                                <h3 class="text-dark mt-1"><span data-plugin="circle">{{ $radius.'km' }}</span></h3>
                                <p class="text-muted mb-1 text-truncate">+ Add Radius</p>
                            </div>
                        </div>
                    </div> <!-- end row-->
                </a>
                    ...
                    <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="width: 36px;">
                                    @if($sp->profile_image)
                                    <img src="{{ Storage::disk('spaces')->url('thumbs/'.$sp->profile_image) }}" alt="User Image" class="rounded-circle avatar-sm">
                                    @else
                                ...
                                <td>
                                    {{ $sp->country_code.''.$sp->phone }}
                                </td>

                                <td>
                                    <a  title="View" href="{{ url('admin/consultants') .'/'.$sp->id}}" class="btn btn-sm btn-info "><i class="fe-eye"></i></a>
                                </td>
...
<script type="text/javascript">
    ...
    var chart = new ApexCharts(document.querySelector("#sales-analyticsWeeklyClass"), options);
    chart.render();
    ...
    var chart = new ApexCharts(document.querySelector("#sales-analyticsMonthlyClass"), options);
    chart.render();
