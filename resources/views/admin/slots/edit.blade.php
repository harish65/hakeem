              ...
              <div class="form-group">
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input type="number" name="slot_value" class="form-control" required  value="{{$slot->slot_value}}"> 
                           <!-- <select type="text" class="form-control" name="slot_value" required>
                              <option>Please Choose Slots</option>
                              {{$slot->slot_value}}
                              <option value="15"
