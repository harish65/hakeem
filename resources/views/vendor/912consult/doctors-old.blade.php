@extends('vendor.912consult.layouts.index', ['title' => 'Doctor'])
@section('content')
            ...
            <div class="container">
                <div class="row bannar-text">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <a class="mr-4" target="__blank" href="https://play.google.com/store/apps/details?id=com.mydoctor.expert"><img src="{{ asset('assets/healtcaremydoctor/images/ic_google-new.png') }}"></a>
