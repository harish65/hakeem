                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div  class="input-group date" data-date-format="mm-dd-yyyy">
                                                <input class="form-control bg-transparent border-0" type="date" value="{{ isset($user->profile->dob) ? $user->profile->dob : ''}}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control phone_patient" type="tel"  onkeypress="return isNumberKey(event)" value="{{ isset($user->phone) ? $user->phone : '' }}"   id="phone" name="phone" @if($user->phone != '') readonly @endif>
                                    <span class="text-danger error"></span>
                                    <input type="hidden" name="country_code" id="country_code" value="{{ isset($user->country_code) ? str_replace('+', '', $user->country_code) : '' }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="state" id="state_filter">
                                           <option value="">Select State</option>
                                            ...
                                            <option value="{{ $name }}" @if($name == (isset($user->profile->state) ? $user->profile->state : '')) selected @endif >{{ $name }}</option>
                                            @endforeach
