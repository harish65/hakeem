...
<div class="offset-top"></div>
    <!-- Home Banner Section -->
    <section class="bannerSection  dr-slider mt-0" style="<?php if(isset($banners)){echo 'margin-top: 10px';}else{echo 'margin-top: 245px';}?> !important;">
            ...
            <div class="container">
                <div class="row bannar-text">
                    <div class="col-lg-6 col-md-6">
                        <h5 style="color:#000 !important">The 912Consult </h5>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Doctor consultation with The 912Consult is an easiest and most convenient way to address your health concerns.</p>
                </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    ...
                    <p>The 912Consult is available for your smartphone. Download our app and enjoy the mobile experience</p>
                    <a class="mr-4" target="__blank" href="https://play.google.com/store/apps/details?id=com.mydoctor.user"><img src="{{ asset('assets/healtcaremydoctor/images/ic_google-new.png') }}"></a>
                    <a href=""><img src="{{ asset('assets/healtcaremydoctor/images/ic_apple-new.png') }}"></a>
                    <div class="row">
                        <div class="col-md-10">
