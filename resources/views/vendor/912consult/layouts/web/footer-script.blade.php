...
<!-- footer -->
<script src="{{asset('assets/912consult/js/jquery-min.js')}}"></script>
<script src="{{asset('assets/912consult/js/slick.min.js')}}"></script>
<script src="{{asset('assets/912consult/js/bootstrap.min.js')}}"></script>

<script src="{{asset('assets/912consult/js/star-rating.min.js')}}" type="text/javascript"></script>
<script>
(function ($) {
    "use strict";
...
<script src="{{ asset('assets/912consult/js/jquery.toast.min.js') }}"></script>
