            ...
            <div class="message_wrapper mt-lg-5 mt-4">
                <div class="row no-gutters">
                    ...
                    <ul class="chat-user border-bottom d-flex align-items-center justify-content-start">
                            <li class="doctor_pic">
                                @if($request_dt)
                                <img src="{{ Storage::disk('spaces')->url('uploads/'.($request_dt && $request_dt->sr_info)?$request_dt->sr_info->profile_image:'') }}" alt="">
                                @endif
                            </li>
                            <li class="doctor_detail pl-3">
                    ...
                    @endif
                        ...
                        <div class="send_msg_box position-relative">
                            <div class="form-group p-0 d-flex align-items-center mb-0">
                                ...
                                <input class="form-control border-0 pr-50" type="" name="" placeholder="Write your message here…" id="message">
                               @php 
...
@section('script')
    ...
    //var socket = io.connect(socket_url, { query: "domain=care_connect_live,user_id="+parseInt(user_id) }); // for live
