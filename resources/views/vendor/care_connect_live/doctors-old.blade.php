@extends('vendor.care_connect_live.layouts.index', ['title' => 'Doctor'])
@section('content')
            ...
            <div class="container">
                <div class="row bannar-text">
                    <div class="col-lg-6 col-md-6">
                        <h5>The Finest Healthcare For Doctors</h5>
                        <h2>Welcome to the service you can trust.</h2>
                        <a class="mr-4" target="__blank" href="https://play.google.com/store/apps/details?id=com.mydoctor.expert"><img src="{{ asset('assets/care_connect_live/images/ic_google-new.png') }}"></a>
                        <a href=""><img src="{{ asset('assets/care_connect_live/images/ic_apple-new.png')}}"></a>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 text-center">
                    <img src="{{ asset('assets/care_connect_live/images/ic_doctor.png') }}">
                    <h5 class="mt-3 mb-0">Book Doctor</h5>
                    <h4>Appointment</h4>
                </div>
                <div class="col-md-3 text-center">
                    <img src="{{ asset('assets/care_connect_live/images/ic_online.png') }}">
                    <h5 class="mt-3 mb-0">Consult doctor by</h5>
                    <h4>Chat, Call and Video</h4>
                </div>
                <div class="col-md-3 text-center">
                    <img src="{{ asset('assets/care_connect_live/images/ic_ask_doctor.png') }}">
    ...
    <section class="download-our-app">
        <div class="container">
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6">
                    <img class="img-fluid simulator" src="{{ asset('assets/care_connect_live/images/ic_simulator-new.png')}}">
                </div>
            </div>
        </div>
    </section>
