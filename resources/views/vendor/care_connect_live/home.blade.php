...
@section('content')
<style>
section.consult-expert.without-bg-image .slick-list.draggable {
width: 100%;
float: left;
}
</style>
            ...
            <div class="container">
                <div class="row bannar-text">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <a class="mr-4" href=""><img src="{{ asset('assets/care_connect_live/images/ic_google-new.png') }}"></a>
