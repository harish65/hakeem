@extends('vendor.care_connect_live.layouts.index', ['title' => 'Patient'])
@section('content')
            ...
            <div class="container">
                <div class="row bannar-text">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <a class="mr-4" target="__blank" href="https://play.google.com/store/apps/details?id=com.mydoctor.user"><img src="{{ asset('assets/care_connect_live/images/ic_google-new.png') }}"></a>
