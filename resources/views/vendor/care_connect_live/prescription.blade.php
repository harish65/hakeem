                            ...
                            <div class="bg-them p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4">
                                        <a class="availability mb-4 d-block" href="{{url('user/requests')}}"><i class="fas fa-plus"></i> Choose Appointment </a>
                                    ...
                                    <div class="col-12 mt-4">
                                        ...
                                        <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" class="availability mb-4 d-block border-line-bottom " style="color: #020202 !important;"  name="medicine_name" placeholder="Medicine Name" >
                                                    </div>
                                                </div>
                                        </div>
