{{--  <!-- footer -->
    ...
    <script type="text/javascript" src="{{ asset('assets/hexalud/js/main.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets/hexalud/js/custom.js') }}"></script>
    <script src="{{asset('assets/iedu/js/intlTelInput.js')}}"></script>

    <!-- <script type="text/javascript" src="{{ asset('assets/hexalud/js/script.js') }}"></script> -->
