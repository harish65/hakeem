...
<section class="new-footer">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <h4>COMPANY</h4>
                <p><a href="{{ url('/about') }}" target="_blank">About Us</a></p>
                <p><a href="{{ url('term-conditions') }}" target="_blank">Terms and conditions</a></p>
            ...
            <div class="col-md-5">
                ...
                <p><a href="{{ url('/web/blogs') }}">Blogs</a></p>
...
<div class="copyright-text">
    <div class="container">
        <small>Copyright © 2021 Hexalud Pvt. Ltd. All Rights Reserved.</small>
    </div>
</div>
 <!-- Select User Modal -->
            ...
            <div class="modal-dialog modal-md ">
                <div class="modal-content">
                    <div class="modal-header d-block pt-3 px-4 pb-0 border-0">
                        ...
                        <h4 class="modal-title login-head">Are you a Expert or Patient?</h4>
                        <hr>
                    </div>
                    <div class="row select-doc-pat">
                        <div class="col-md-6 text-center">
                            <a href="#" data-type="service_provider" id="doctor_sign_up_modal_btn">
                                ...
                                <span class="d-block heading-28 mb-4"> Expert </span>
                            </a>
                        </div>
            ...
            <div class="modal-dialog modal-md ">
                <div class="modal-content ">
                    ...
                    <div class="modal-body px-4 py-3">
                        ...
                        <p class="text-center mt-5 pt-lg-5">By continuing, you agree to our <a href="{{ url('term-conditions') }}" target="_blank">Terms of Service </a> and <br> <a href="{{ url('privacy-policy') }}"> Privacy policy</a></p>
                    </div>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body px-4 pt-2 pb-3" id="login_form" name="c-form">
                    ...
                    <form class="form-default" id="otp_login" role="form" action="#" method="POST">
                        ...
                        <p class="text-center mt-4" ><span>By continuing, you agree to our </span><a href="{{ url('term-conditions') }}">Terms of Service </a> <span>and</span> <br> <a href="{{ url('privacy-policy') }}"> Privacy policy</a></p>
                     </form>
                </div>
                <div class="modal-footer text-center mt-3 border-0 d-block bg-clr ">
