...
<!-- footer -->
<script src="{{asset('assets/hexalud/js/jquery-min.js')}}"></script>
<script src="{{asset('assets/hexalud/js/slick.min.js')}}"></script>
<script src="{{asset('assets/hexalud/js/bootstrap.min.js')}}"></script>
...
<script src="{{asset('assets/hexalud/js/owl.carousel.min.js')}}"></script>
<script src="{{asset('assets/hexalud/js/main.js')}}"></script>
<script src="{{asset('assets/hexalud/js/intlTelInput.js')}}"></script>
<script src="{{ asset('assets/hexalud/js/custom.js')}}"></script>
<script src="{{ asset('assets/hexalud/js/jquery.toast.min.js') }}"></script>
 ...
 $('.show-tprice').removeClass("d-none");
        ...
        $.post(_url, $("#create_request").serialize())
            ...
            .fail(function(jqxhr, settings, ex) {
                ...
                if(jqxhr.responseJSON.status="error")
                     {
                        {{-- $("#wallet_message").text(jqxhr.responseJSON.message); --}}
                        swal.fire({
                            title: "",
    ...
    $('#add_money').on('click',function(){
        ...
        if(amount =='' || amount ==null){
            ...
            Swal.fire('Minimum amount should be $50')
        }else{
...
function payWithStripe(e) {
    ...
    var PublishableKey = 'pk_test_TYooMQauvdEDq54NiTphI7jx'; // Replace with your API publishable key
