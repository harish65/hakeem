                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="">Title<span class="error">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="">Full Name<span class="error">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="">Email<span class="error">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="">Date of birth<span class="error">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label class="">Working Since<span class="error">*</span></label>
                                            <div class="input-group date" data-date-format="mm-dd-yyyy">
                                                <input class="form-control bg-transparent border-0" type="text" value="{{ isset($profile->working_since) ? '' : ''}}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="{{$Gender[0]->preferid ?? 1}}" name="gender">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="{{$language[0]->preferid ?? 2}}" name="language">
