@extends('vendor.iedu.layouts.index', ['title' => 'Profile'])
@section('content')
 <!-- Offset Top -->
 <style>
                ...
                <div class="col-lg-4 pr-lg-0">
                    <div class="bg-them border-0 text-center mb-4 p-5">
                        <div class="position-relative">
                                    ...
                                    @else
                                    <img class="user-profile showImg" src="{{asset('assets/images/ic_upload profile img.png')}}" alt="" id="showImg">
                                    @endif

                            <div class="img-wrapper position-absolute">
                                <label for="image_upload2" class="img-upload-btn"><i class="fa fa-pencil" id="" aria-hidden="true"></i></label>
                                <input type="file" id="image_upload2" name="profile_image" accept=".jpg, .jpeg, .png" style="opacity: 0;">
                            </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input readonly class="form-control phone_patient" type="tel"  onkeypress="return isNumberKey(event)" value="{{ isset($user->phone) ? $user->phone : '' }}"   id="phone" name="phone">
                            ...
                            <div class="col-12">
                                <div class="form-footer2">
                                    <input type="submit" name="update" class="btn rounded radius-btn" value="Update">
                                </div>
                            </div>
                        </div>
