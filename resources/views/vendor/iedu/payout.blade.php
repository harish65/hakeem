@extends('vendor.iedu.layouts.index', ['title' => 'Payouts'])
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8 pr-lg-4">
                    ...
                    <form method="post" action="{{url('service_provider/payouts')}}">
                        <div class="balance-box bg-them border-0 mb-lg-3 mb-3 d-flex justify-content-between align-items-center">
                           <div class="balance-left">
                            ...
                            <div class="balance-right">
                                <input class="default-btn btn radius-btn" type="submit" name="submit" value="Payout" />
                    ...
                    <form action="{{url('service_provider/add-bank')}}" method="post">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <input class="default-btn btn radius-btn " type="submit" value="Submit" name="Submit" />
                            </div>
                            </div>
                        </form>
