...
$(document).ready(function(){
	...
	$("#btn_messaging_chat").trigger('click');
...
$(document).ready(function(){
	...
	$("#triggersection").trigger('click');

  $("#good").trigger('click');
})
	
</script>
<button style="display: none" type="submit" class="modal-messaging-list__item"  id="good" >vikash  <div class="modal-messaging-list__icon modal-messaging-list__icon--select" data-guest-id="12"></div></button>

<button style="display: none" type="button" id="triggersection" class="modal-messaging-bottom__button" onclick="startMessaging()">START MESSAGE</button>
  ...
  <button style="display: none" type="button"  id="poopup" class="modal-confirm-button modal-confirm-submit">YES</button>
      ...
      <div class="chat">
        ...
        <div class="chat-input">
          ...
          <label class="chat-input-file" for="chat_file_input">
            <input type="file" name="file" id="chat_file_input" style="display: block;">
          </label>  
          <!--[if gt IE 7]>
          <script>
