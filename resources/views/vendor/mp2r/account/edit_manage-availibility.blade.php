            ...
            <div class="col-md-4 col-lg-4 col-sm-4">
                <div class="left-dashboard2 mt-4">
                    ...
                    <ul class="left-side-bar mb-3">
                        <div class="tab">
                            <li class="tablinks" onclick="openCity(event, 'manage_availability')" id="defaultOpen">Manage Availability</li>
            ...
            <div class="row m-0">
                <div class="col-md-12">
                 <div class="form-group form-check">
                      ...
                      <input id="onclickdate" @input="clickHadleType('specific_date')" class="form-check-input pr-2" type="checkbox" checked=""><label class="form-check-label pb-0 checkbox-label">Select availabilty for Particular date
                    </label>
                  </div>
                </div>
            </div>
