	...
	<div class="row ">  
		...
		<div class="col-md-8 col-lg-8">
			...
			<section class="account-details">
				...
				<form id="step_first" enctype="multipart/form-data" method="post">
					...
					<div class="col-md-6">
						<div class="form-group">
						   ...
						   <div class="input-outer d-flex align-items-center p-2">
							   ...
							   <input type="number" min ="0" class="border-0 pl-2" id="phone_number" placeholder="9984929384" name="phone"  onkeypress="return isNumber(event)" >
						   </div>
				...
				<div class="row pb-3">
					...
					<div class="col-md-6">
						...
						<label for="pwd2">Confim Password</label>
						 <input type="password" class="form-control" id="pwd2" placeholder="************" name="password_confirmation">
		...
		<div class="row">
			<div class="col-md-12 col-lg-9 col-sm-12">
				<div class="row align-items-center">
					<div class="col-md-6 col-sm-12 col-lg-6"><button id="btn_text" form="step_first" type="submit" class="btn-next">Next</button></div>
