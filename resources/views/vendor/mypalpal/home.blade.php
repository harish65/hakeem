            ...
            <div class="container">
                <div class="row bannar-text">
                    <div class="col-lg-6 col-md-6">
                        <h5 style="color:#000 !important">The My PalPal </h5>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Doctor consultation with The My PalPal is an easiest and most convenient way to address your health concerns.</p>
                </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    ...
                    <p>The My PalPal is available for your smartphone. Download our app and enjoy the mobile experience</p>
                    <a class="mr-4" target="__blank" href="https://play.google.com/store/apps/details?id=com.mydoctor.user"><img src="{{ asset('assets/healtcaremydoctor/images/ic_google-new.png') }}"></a>
                    <a href=""><img src="{{ asset('assets/healtcaremydoctor/images/ic_apple-new.png') }}"></a>
                    <div class="row">
                        <div class="col-md-10">
