...
<html lang="en">
    <head>
        ...
        @include('vendor.mypalpal.layouts.web/header-script', ['title' => $title])
    </head>
    ...
    <body data-layout-mode="detached" @yield('body-extra')>
        ...
        <div id="overlay" class="overlayq">
            ...
            @if(!isset($no_header_footer))
                @include('vendor.mypalpal.layouts.web/footer')
            @endif
    ...
    @include('vendor.mypalpal.layouts.shared.firebase')
    </body>
</html>
