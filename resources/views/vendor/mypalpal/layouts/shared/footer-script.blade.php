<!-- footer -->
    ...
    <script src="{{ asset('assets/mypalpal/js/slick.min.js')}}"></script>
    <script src="{{ asset('assets/mypalpal/js/bootstrap.min.js')}}"></script>
    <!-- Date Rang JS -->
    <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
    <script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
    <script src="{{ asset('assets/mypalpal/js/owl.carousel.min.js')}}"></script>
    <script src="{{ asset('assets/mypalpal/js/main.js')}}"></script>
    <script src="{{ asset('assets/mypalpal/js/custom.js')}}"></script>
    <script src="{{asset('assets/libs/sweetalert2/sweetalert2.min.js')}}"></script>
    <script src="{{ asset('assets/mypalpal/js/intlTelInput.js')}}"></script>
