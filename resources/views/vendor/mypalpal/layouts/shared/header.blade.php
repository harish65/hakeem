    ...
    line-height: 40px;
                    ...
                    @if(Auth::check())
                        ...
                        <a class="navbar-brand" href="{{ url('/user/patient') }}">
                            <img src="{{ asset('assets/mypalpal/images/mypalpal.png') }}" alt="" style="width:100px;">
                        </a>
                        @endif
                        ...
                        <a class="navbar-brand" href="{{ url('/') }}">
                            <img src="{{ asset('assets/mypalpal/images/mypalpal.png') }}" alt="" style="width:100px;"></a>
                        @endif
                    @else
                            <a class="navbar-brand" href="{{ url('/') }}">
                            <img src="{{ asset('assets/mypalpal/images/mypalpal.png') }}" alt="" style="width:100px;">
                            ...
                            <ul class="navbar-nav ml-auto py-4 py-md-0">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item {{ request()->get('tab')=='about'?'active':''  }}">
                                        <a class="nav-link menudata" href="{{ url('/about') }}">About us</a>
                                    </li>
