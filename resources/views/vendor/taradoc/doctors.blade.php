@extends('vendor.taradoc.layouts.index', ['title' => 'Doctor'])
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Doctor consultation with TaraDoc is an easiest and most convenient way to address your health concerns.</p>
                </div>
                <div class="col-md-3 text-center">
                    <img src="{{ asset('assets/taradoc/images/ic_doctor.png') }}">
                    <h5 class="mt-3 mb-0">Book Doctor</h5>
                    <h4>Appointment</h4>
                </div>
                <div class="col-md-3 text-center">
                    <img src="{{ asset('assets/taradoc/images/ic_online.png') }}">
                    <h5 class="mt-3 mb-0">Consult doctor by</h5>
                    <h4>Chat, Call and Video</h4>
                </div>
                <div class="col-md-3 text-center">
                    <img src="{{ asset('assets/taradoc/images/ic_ask_doctor.png') }}">
