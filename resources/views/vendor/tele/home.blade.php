@extends('vendor.tele.layouts.index', ['title' => 'Home'])
@section('content')

<div class="offset-top"></div>
    <!-- Home Banner Section -->
    <section class="bannerSection  dr-slider mt-0" style="margin-top: 245px !important;">
            ...
            <div class="container">
                <div class="row bannar-text">
                    <div class="col-lg-6 col-md-6">
                        <h5 style="color:#000 !important">The Telegreen </h5>
                        <h2 style="color:#000 !important;font-size:25px !important;">Welcome to Medical services you can trust.</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Doctor consultation with The Telegreen is an easiest and most convenient way to address your health concerns.</p>
                </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6">
                    ...
                    <p>The Telegreen is available for your smartphone. Download our app and enjoy the mobile experience</p>
                    <a class="mr-4" target="__blank" href="https://play.google.com/store/apps/details?id=com.mydoctor.user"><img src="{{ asset('assets/healtcaremydoctor/images/ic_google-new.png') }}"></a>
                    <a href=""><img src="{{ asset('assets/healtcaremydoctor/images/ic_apple-new.png') }}"></a>
                    <div class="row">
                        <div class="col-md-10">
