...
@section('content')
 ...
 <div class="offset-top"></div>
    ...
    <section class="consult-expert">
        <div class="container">
            <h2 class="cluster-expert">Consult Expertsddd</h2>
            ...
            <div class="row items_cat">
                ...
                <div class="col-md-3 col-lg-3 col-sm-6">
                    ...
                    <div class="outer-phy d-flex align-items-center" style="background-color:{{ $category->color_code }}">
                     <span>
                        <img style="position:absolute;height: 120px;bottom: 10px;"  src="{{ Storage::disk('spaces')->url('original/'.$category->image) }}" class="img-fluid">
                    </span>
                        <h3 class="general">
                            {{ $category->name }}
                            <h3>
            ...
            <div class="get-first">
                <h3>Get first consultation free with Telegreen</h3>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 offset-lg-1 col-md-8">
                    <h2>Download the Telegreen app</h2>
                    <div class="row">
                        <div class="col-md-6">
